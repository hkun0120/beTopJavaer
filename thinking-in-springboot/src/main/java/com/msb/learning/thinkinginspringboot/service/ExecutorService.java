...
import com.msb.learning.thinkinginspringboot.bean.RouteInfo;
import com.msb.learning.thinkinginspringboot.config.ExecutorConfig;
...
public class ExecutorService {
    ...
    public void test() throws ExecutionException, InterruptedException {
        ...
        QueryTask queryTask1 = new QueryTask(cntrNo,routeInfo, 200);
        QueryTask queryTask2 = new QueryTask(cntrNo,routeInfo, 300);
        QueryTask queryTask3 = new QueryTask(cntrNo,routeInfo, 400);
        QueryTask queryTask4 = new QueryTask(cntrNo,routeInfo, 500);

        long startTime = System.currentTimeMillis();
        Future<List<String>> future1 = threadPoolTaskExecutor.submit(queryTask1);
        Future<List<String>> future2 = threadPoolTaskExecutor.submit(queryTask2);
        Future<List<String>> future3 = threadPoolTaskExecutor.submit(queryTask3);
        Future<List<String>> future4 = threadPoolTaskExecutor.submit(queryTask4);
        ...
        future4.get();
        System.out.println("4线程花费时间："+(System.currentTimeMillis()-startTime)+"ms");
    }
